# -*- coding: utf-8 -*-
"""
Created on Thu Jul  8 20:30:12 2021
...
import requests # imports des datasets via drive 
from io import StringIO # imports des datasets via drive 

## URL PUBLIC DRIVE DES DATASETS
# events : https://drive.google.com/file/d/1WyCx3QZfh69IuPmi8mA3LHXb-vSosmYs/view?usp=sharing
# Category : https://docs.google.com/spreadsheets/d/1LdQz4k1X9vrrlxplLr82dtLjjeiQQ7xOsW6rjvX9it8/edit?usp=sharing
# item_properties 1 : https://drive.google.com/file/d/1JzUOEQTTnVvDbZ2Pm1oSNyB4aeBzT-jn/view?usp=sharing 
# item_properties 2 : https://drive.google.com/file/d/1edNeLp9XpGM-KWdyYtKAz0yfd4Nx13x-/view?usp=sharing

# df_all : https://drive.google.com/file/d/1DqXMIdU912x0h_f9W9Tk5ZdcYEIzwQ4l/view?usp=sharing
...
if page == 'Segmentation visiteurs':
    ...
    if (status == 'Ensemble des visiteurs'): 
        ...
        st.write("""
                 'allure de la représentation graphique n'échappe pas à la nature désésquilibrée du dataset.
